...
Attribute HSV.VB_Description = "Returns a Long value representing the RGB equivalent of the given Hue, Saturation and Brightness. Hue Range: -1 to 360. Saturation Range: 0 to 1. Brightness Range: 0 to 1. (Use as a direct replacement for VB's internal RGB function.)"
    ...
    ' =================================================================================================
    ' Given a Hue, Saturation and Brightness, returns the Red-Green_Blue equivalent as a Long data type.
...
Public Function ConvertRGBtoHSV(Red As Integer, Green As Integer, Blue As Integer, Hue As Single, Saturation As Single, Brightness As Single)
Attribute ConvertRGBtoHSV.VB_Description = "Returns the Hue, Saturation and Brightness, given the Red, Green and Blue components of a colour. RGB ranges: 0 to 255."
